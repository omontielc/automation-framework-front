...
public class ATC02_SauceDemoTest extends TestBase {

    private static final Logger logger = LogManager.getLogger(ATC02_SauceDemoTest.class);

    /**
     * Registers this test class with {@link TestBase} using {@link #ATC_NAME}.
     */
    public ATC02_SauceDemoTest() {
        super(ATC02_SauceDemoTest.class.getSimpleName());
    }
