...
public class ATC04_SauceDemoTest extends TestBase {

    private static final Logger logger = LogManager.getLogger(ATC04_SauceDemoTest.class);

    /**
     * Registers this test class with {@link TestBase} using {@link #ATC_NAME}.
     */
    public ATC04_SauceDemoTest() {
        super(ATC04_SauceDemoTest.class.getSimpleName());
    }
