...
public class ATC03_SauceDemoTest extends TestBase {

    private static final Logger logger = LogManager.getLogger(ATC03_SauceDemoTest.class);

    /**
     * Registers this test class with {@link TestBase} using {@link #ATC_NAME}.
     */
    public ATC03_SauceDemoTest() {
        super(ATC03_SauceDemoTest.class.getSimpleName());
    }
